...
var Lemmatizer = function(absPathPrefix) {
  this.wn_files = {
    noun: [
      absPathPrefix+'/dict/index.noun.json',
      absPathPrefix+'/dict/noun.exc.json'
    ],
    verb: [
      absPathPrefix+'/dict/index.verb.json',
      absPathPrefix+'/dict/verb.exc.json'
    ],
    adj:  [
      absPathPrefix+'/dict/index.adj.json',
      absPathPrefix+'/dict/adj.exc.json'
    ],
    adv:  [
      absPathPrefix+'/dict/index.adv.json',
      absPathPrefix+'/dict/adv.exc.json'
    ]
  };
