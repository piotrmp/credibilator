...
pathDocumentMetadata = '../data/metadata.tsv'
pathDocument2D = '../data/styleU50pSfixC.ssv'
...
titles = [None]*95900
count = 0
with io.open(pathDocumentMetadata,'r',encoding='utf-8') as inFile:
    for line2 in inFile:
        if (count >0):
...
with io.open(pathDocumentMetadata,"r",encoding="utf-8") as infileSent:
    lineCount = 0 
...
min1 = 0
min2 = 0
with io.open(pathDocument2D,'r',encoding='utf-8') as inFile:
    for line1 in inFile:
